...
Parts left out that would make this stand out better include mapping the longitude gridlines from the temperature plot all the way up through the movements plot, which is a theme mapping componenet that I tried to mess with, ultimately failed in doing it. I also left out adding the dates and better labeling the temperature points.